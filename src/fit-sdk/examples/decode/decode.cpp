...
public:
	...
	void OnMesg(fit::Mesg &mesg) {
		printf("On Mesg:\n");
		std::wcout << L"   New Mesg: " << mesg.GetName().c_str() << L".  It has " << mesg.GetNumFields()
		           << L" field(s) and " << mesg.GetNumDevFields() << " developer field(s).\n";
...
int main(int argc, char *argv[]) {
	...
	// messages only) decode.IncompleteStream(); // This suppresses exceptions with unexpected eof (also incorrect crc)
