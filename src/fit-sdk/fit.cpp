...
const FIT_UINT8 baseTypeSizes[FIT_BASE_TYPES] = {
    sizeof(FIT_ENUM),   sizeof(FIT_SINT8),   sizeof(FIT_UINT8),   sizeof(FIT_SINT16),  sizeof(FIT_UINT16),
    sizeof(FIT_SINT32), sizeof(FIT_UINT32),  sizeof(FIT_STRING),  sizeof(FIT_FLOAT32), sizeof(FIT_FLOAT64),
    sizeof(FIT_UINT8Z), sizeof(FIT_UINT16Z), sizeof(FIT_UINT32Z), sizeof(FIT_BYTE),    sizeof(FIT_SINT64),
    sizeof(FIT_UINT64), sizeof(FIT_UINT64Z),
};
...
static const FIT_FLOAT floatInvalid = {{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}};
...
const std::map<ProtocolVersion, DetailedProtocolVersion> versionMap {
    {ProtocolVersion::V10, DetailedProtocolVersion(1, 0)}, {ProtocolVersion::V20, DetailedProtocolVersion(2, 0)}};
