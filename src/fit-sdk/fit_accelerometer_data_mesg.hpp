...
public:
	...
	// Units: ms
	// Comment: Each time in the array describes the time at which the accelerometer sample with the corrosponding index
	// was taken. Limited to 30 samples in each message. The samples may span across seconds. Array size must match the
	// number of samples in accel_x and accel_y and accel_z
	///////////////////////////////////////////////////////////////////////
	...
	// Units: counts
	// Comment: These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span
	// across seconds. A conversion will need to be done on this data once read.
	///////////////////////////////////////////////////////////////////////
