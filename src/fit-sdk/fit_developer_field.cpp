...
namespace fit {
DeveloperField::DeveloperField(void) : FieldBase(), mDefinition(nullptr) {
}

DeveloperField::DeveloperField(const DeveloperField &other) : FieldBase(other), mDefinition(nullptr) {
...
DeveloperField::DeveloperField(const DeveloperFieldDefinition &definition)
    : FieldBase(), mDefinition(new DeveloperFieldDefinition(definition)) {
}

DeveloperField::DeveloperField(const FieldDescriptionMesg &definition, const DeveloperDataIdMesg &developer)
    : FieldBase(), mDefinition(new DeveloperFieldDefinition(definition, developer, 0)) {
}
