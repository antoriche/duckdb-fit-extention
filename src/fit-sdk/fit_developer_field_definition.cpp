...
DeveloperFieldDefinition::DeveloperFieldDefinition()
    : num(FIT_FIELD_NUM_INVALID), size(0), developerDataIndex(FIT_UINT8_INVALID), mesg(nullptr), developer(nullptr) {
}

DeveloperFieldDefinition::DeveloperFieldDefinition(const DeveloperFieldDefinition &other)
    : num(other.num), size(other.size), developerDataIndex(other.developerDataIndex), mesg(nullptr),
      developer(nullptr) {
...
DeveloperFieldDefinition::DeveloperFieldDefinition(FIT_UINT8 fieldNum, FIT_UINT8 size, FIT_UINT8 developerDataIndex)
    : num(fieldNum), size(size), developerDataIndex(developerDataIndex), mesg(nullptr), developer(nullptr) {
}

DeveloperFieldDefinition::DeveloperFieldDefinition(const FieldDescriptionMesg &desc,
                                                   const DeveloperDataIdMesg &developer, FIT_UINT8 size)
    : num(desc.GetFieldDefinitionNumber()), size(size), developerDataIndex(desc.GetDeveloperDataIndex()),
      mesg(new FieldDescriptionMesg(desc)), developer(new DeveloperDataIdMesg(developer)) {
}
