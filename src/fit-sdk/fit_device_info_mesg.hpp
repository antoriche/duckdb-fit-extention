...
public:
	...
	void SetBleDeviceType(FIT_BLE_DEVICE_TYPE bleDeviceType) {
		SetFieldUINT8Value(1, bleDeviceType, 0,
		                   (FIT_UINT16)Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_BLE_DEVICE_TYPE);
	}
	...
	void SetAntplusDeviceType(FIT_ANTPLUS_DEVICE_TYPE antplusDeviceType) {
		SetFieldUINT8Value(1, antplusDeviceType, 0,
		                   (FIT_UINT16)Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANTPLUS_DEVICE_TYPE);
	}
	...
	void SetAntDeviceType(FIT_UINT8 antDeviceType) {
		SetFieldUINT8Value(1, antDeviceType, 0,
		                   (FIT_UINT16)Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANT_DEVICE_TYPE);
	}
	...
	void SetLocalDeviceType(FIT_LOCAL_DEVICE_TYPE localDeviceType) {
		SetFieldUINT8Value(1, localDeviceType, 0,
		                   (FIT_UINT16)Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_LOCAL_DEVICE_TYPE);
	}
