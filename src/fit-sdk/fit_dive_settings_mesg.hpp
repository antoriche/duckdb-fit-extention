...
public:
	...
	FIT_BOOL IsHeartRateAntplusDeviceTypeValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_ANTPLUS_DEVICE_TYPE)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_ANTPLUS_DEVICE_TYPE);
	}
	...
	FIT_ANTPLUS_DEVICE_TYPE GetHeartRateAntplusDeviceType(void) const {
		return GetFieldUINT8Value(
		    20, 0, (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_ANTPLUS_DEVICE_TYPE);
	}
	...
	void SetHeartRateAntplusDeviceType(FIT_ANTPLUS_DEVICE_TYPE heartRateAntplusDeviceType) {
		SetFieldUINT8Value(
		    20, heartRateAntplusDeviceType, 0,
		    (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_ANTPLUS_DEVICE_TYPE);
	}
	...
	FIT_BOOL IsHeartRateLocalDeviceTypeValid() const {
		...
		if (!CanSupportSubField(
		        field, (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_LOCAL_DEVICE_TYPE)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_LOCAL_DEVICE_TYPE);
	}
	...
	FIT_LOCAL_DEVICE_TYPE GetHeartRateLocalDeviceType(void) const {
		return GetFieldUINT8Value(
		    20, 0, (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_LOCAL_DEVICE_TYPE);
	}
	...
	void SetHeartRateLocalDeviceType(FIT_LOCAL_DEVICE_TYPE heartRateLocalDeviceType) {
		SetFieldUINT8Value(
		    20, heartRateLocalDeviceType, 0,
		    (FIT_UINT16)Profile::DIVE_SETTINGS_MESG_HEART_RATE_SOURCE_FIELD_HEART_RATE_LOCAL_DEVICE_TYPE);
	}
