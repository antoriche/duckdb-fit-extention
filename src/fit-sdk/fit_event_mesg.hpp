...
public:
	...
	void SetVirtualPartnerSpeed(FIT_FLOAT32 virtualPartnerSpeed) {
		SetFieldFLOAT32Value(3, virtualPartnerSpeed, 0,
		                     (FIT_UINT16)Profile::EVENT_MESG_DATA_FIELD_VIRTUAL_PARTNER_SPEED);
	}
	...
	void SetDistanceDurationAlert(FIT_FLOAT32 distanceDurationAlert) {
		SetFieldFLOAT32Value(3, distanceDurationAlert, 0,
		                     (FIT_UINT16)Profile::EVENT_MESG_DATA_FIELD_DISTANCE_DURATION_ALERT);
	}
	...
	void SetCalorieDurationAlert(FIT_UINT32 calorieDurationAlert) {
		SetFieldUINT32Value(3, calorieDurationAlert, 0,
		                    (FIT_UINT16)Profile::EVENT_MESG_DATA_FIELD_CALORIE_DURATION_ALERT);
	}
	...
	void SetFitnessEquipmentState(FIT_FITNESS_EQUIPMENT_STATE fitnessEquipmentState) {
		SetFieldENUMValue(3, fitnessEquipmentState, 0,
		                  (FIT_UINT16)Profile::EVENT_MESG_DATA_FIELD_FITNESS_EQUIPMENT_STATE);
	}
	...
	void SetAutoActivityDetectDuration(FIT_UINT16 autoActivityDetectDuration) {
		SetFieldUINT16Value(3, autoActivityDetectDuration, 0,
		                    (FIT_UINT16)Profile::EVENT_MESG_DATA_FIELD_AUTO_ACTIVITY_DETECT_DURATION);
	}
	...
	// Comment: The first byte is the radar_threat_level_max, the second byte is the radar_threat_count, third bytes is
	// the average approach speed, and the 4th byte is the max approach speed
	///////////////////////////////////////////////////////////////////////
	...
	// Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield components. Front gear
	...
	// Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield components. Number of front
	// teeth.
	///////////////////////////////////////////////////////////////////////
	...
	// Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield components. Rear gear
	// number. 1 is innermost.
	///////////////////////////////////////////////////////////////////////
	...
	// Comment: Do not populate directly. Autogenerated by decoder for gear_change subfield components. Number of rear
	// teeth.
	///////////////////////////////////////////////////////////////////////
	...
	FIT_BOOL IsAutoActivityDetectStartTimestampValid() const {
		...
		if (!CanSupportSubField(
		        field, (FIT_UINT16)Profile::EVENT_MESG_START_TIMESTAMP_FIELD_AUTO_ACTIVITY_DETECT_START_TIMESTAMP)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::EVENT_MESG_START_TIMESTAMP_FIELD_AUTO_ACTIVITY_DETECT_START_TIMESTAMP);
	}
	...
	FIT_DATE_TIME GetAutoActivityDetectStartTimestamp(void) const {
		return GetFieldUINT32Value(
		    15, 0, (FIT_UINT16)Profile::EVENT_MESG_START_TIMESTAMP_FIELD_AUTO_ACTIVITY_DETECT_START_TIMESTAMP);
	}
	...
	void SetAutoActivityDetectStartTimestamp(FIT_DATE_TIME autoActivityDetectStartTimestamp) {
		SetFieldUINT32Value(15, autoActivityDetectStartTimestamp, 0,
		                    (FIT_UINT16)Profile::EVENT_MESG_START_TIMESTAMP_FIELD_AUTO_ACTIVITY_DETECT_START_TIMESTAMP);
	}
