...
FIT_FLOAT32 FieldBase::GetFLOAT32Value(const FIT_UINT8 fieldArrayIndex, const FIT_UINT16 subFieldIndex) const {
	...
	case FIT_BASE_TYPE_BYTE: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_BYTE>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_ENUM: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_ENUM>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_SINT8: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_SINT8>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_UINT8:
	case FIT_BASE_TYPE_UINT8Z: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_UINT8>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_SINT16: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_SINT16>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_UINT16:
	case FIT_BASE_TYPE_UINT16Z: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_UINT16>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_SINT32: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_SINT32>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_UINT32:
	case FIT_BASE_TYPE_UINT32Z: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_UINT32>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_SINT64: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_SINT64>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}

	case FIT_BASE_TYPE_UINT64:
	case FIT_BASE_TYPE_UINT64Z: {
		float32Value = ConvertBaseType<FIT_FLOAT32, FIT_UINT64>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT32);
		break;
	}
	...
	if (memcmp(&float32Value, baseTypeInvalids[FIT_BASE_TYPE_FLOAT32 & FIT_BASE_TYPE_NUM_MASK], sizeof(FIT_FLOAT32)) ==
	    0) {
		return float32Value;
	}

	return static_cast<FIT_FLOAT32>(static_cast<FIT_FLOAT64>(float32Value) / GetScale(subFieldIndex) -
	                                GetOffset(subFieldIndex));
}
...
FIT_FLOAT64 FieldBase::GetFLOAT64Value(const FIT_UINT8 fieldArrayIndex, const FIT_UINT16 subFieldIndex) const {
	...
	switch (GetType()) { // Note: This checks the type of the MAIN field since data is aligned according to that type
	case FIT_BASE_TYPE_BYTE: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_BYTE>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}

	case FIT_BASE_TYPE_ENUM: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_ENUM>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}

	case FIT_BASE_TYPE_SINT8: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_SINT8>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}

	case FIT_BASE_TYPE_UINT8:
	case FIT_BASE_TYPE_UINT8Z: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_UINT8>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}

	case FIT_BASE_TYPE_SINT16: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_SINT16>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}

	case FIT_BASE_TYPE_UINT16Z:
	case FIT_BASE_TYPE_UINT16: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_UINT16>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}

	case FIT_BASE_TYPE_SINT32: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_SINT32>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}

	case FIT_BASE_TYPE_UINT32:
	case FIT_BASE_TYPE_UINT32Z: {
		float64Value = ConvertBaseType<FIT_FLOAT64, FIT_UINT32>(fieldArrayIndex, FIT_BASE_TYPE_FLOAT64);
		break;
	}
	...
	if (memcmp(&float64Value, baseTypeInvalids[FIT_BASE_TYPE_FLOAT64 & FIT_BASE_TYPE_NUM_MASK], sizeof(FIT_FLOAT64)) ==
	    0) {
		return float64Value;
	}
...
FIT_WSTRING FieldBase::GetSTRINGValue(const FIT_UINT8 fieldArrayIndex, const FIT_UINT16 subFieldIndex) const {
	...
	if (GetType() == FIT_BASE_TYPE_STRING) // Note: This checks the type of the MAIN field since data is aligned
...
FIT_BOOL FieldBase::GetMemoryValue(const FIT_UINT8 fieldArrayIndex, FIT_UINT8 *buffer,
                                   const FIT_UINT8 bufferSize) const {
...
void FieldBase::SetFLOAT32Value(const FIT_FLOAT32 value, const FIT_UINT8 fieldArrayIndex,
                                const FIT_UINT16 subFieldIndex) {
	SetFLOAT64Value(value, fieldArrayIndex, subFieldIndex);
}

void FieldBase::SetFLOAT64Value(const FIT_FLOAT64 value, const FIT_UINT8 fieldArrayIndex,
                                const FIT_UINT16 subFieldIndex) {
	if (!IsValid())
		return;
