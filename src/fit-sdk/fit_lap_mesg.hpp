...
public:
	...
	void SetAvgRunningCadence(FIT_UINT8 avgRunningCadence) {
		SetFieldUINT8Value(17, avgRunningCadence, 0,
		                   (FIT_UINT16)Profile::LAP_MESG_AVG_CADENCE_FIELD_AVG_RUNNING_CADENCE);
	}
	...
	void SetMaxRunningCadence(FIT_UINT8 maxRunningCadence) {
		SetFieldUINT8Value(18, maxRunningCadence, 0,
		                   (FIT_UINT16)Profile::LAP_MESG_MAX_CADENCE_FIELD_MAX_RUNNING_CADENCE);
	}
