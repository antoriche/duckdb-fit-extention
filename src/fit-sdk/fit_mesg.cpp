...
Mesg::Mesg() : profile(FIT_NULL), localNum(0), fields(), devFields() {
}

Mesg::Mesg(const Mesg &mesg)
    : profile(mesg.profile), localNum(mesg.localNum), fields(mesg.fields), devFields(mesg.devFields) {
}

Mesg::Mesg(const Profile::MESG_INDEX index) : profile(&Profile::mesgs[index]), localNum(0), fields(), devFields() {
}

Mesg::Mesg(const std::string &name) : profile(Profile::GetMesg(name)), localNum(0), fields(), devFields() {
}

Mesg::Mesg(const FIT_UINT16 num) : profile(Profile::GetMesg(num)), localNum(0), fields(), devFields() {
}
...
const DeveloperField *Mesg::GetDeveloperField(FIT_UINT8 developerDataIndex, FIT_UINT8 num) const {
	for (int i = 0; i < (int)devFields.size(); i++) {
		...
		if ((def.GetNum() == num) && (def.GetDeveloperDataIndex() == developerDataIndex)) {
			return &devFields[i];
		}
	}
...
FIT_ENUM Mesg::GetFieldENUMValue(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                 const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_BYTE Mesg::GetFieldBYTEValue(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                 const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_SINT8 Mesg::GetFieldSINT8Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                   const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT8 Mesg::GetFieldUINT8Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                   const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT8Z Mesg::GetFieldUINT8ZValue(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                     const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_SINT16 Mesg::GetFieldSINT16Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                     const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT16 Mesg::GetFieldUINT16Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                     const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT16Z Mesg::GetFieldUINT16ZValue(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                       const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_SINT32 Mesg::GetFieldSINT32Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                     const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT32 Mesg::GetFieldUINT32Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                     const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT32Z Mesg::GetFieldUINT32ZValue(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                       const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_SINT64 Mesg::GetFieldSINT64Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                     const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT64 Mesg::GetFieldUINT64Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                     const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_UINT64Z Mesg::GetFieldUINT64ZValue(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                       const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_FLOAT32 Mesg::GetFieldFLOAT32Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                       const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_FLOAT64 Mesg::GetFieldFLOAT64Value(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                       const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
FIT_WSTRING Mesg::GetFieldSTRINGValue(const FIT_UINT8 fieldNum, const FIT_UINT8 fieldArrayIndex,
                                      const FIT_UINT16 subFieldIndex) const {
	const Field *field = GetField(fieldNum);
...
void Mesg::SetFieldENUMValue(const FIT_UINT8 fieldNum, const FIT_ENUM value, const FIT_UINT8 fieldArrayIndex,
...
void Mesg::SetFieldBYTEValue(const FIT_UINT8 fieldNum, const FIT_BYTE value, const FIT_UINT8 fieldArrayIndex,
                             const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldSINT8Value(const FIT_UINT8 fieldNum, const FIT_SINT8 value, const FIT_UINT8 fieldArrayIndex,
                              const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT8Value(const FIT_UINT8 fieldNum, const FIT_UINT8 value, const FIT_UINT8 fieldArrayIndex,
                              const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT8ZValue(const FIT_UINT8 fieldNum, const FIT_UINT8 value, const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldSINT16Value(const FIT_UINT8 fieldNum, const FIT_SINT16 value, const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT16Value(const FIT_UINT8 fieldNum, const FIT_UINT16 value, const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT16ZValue(const FIT_UINT8 fieldNum, const FIT_UINT16Z value, const FIT_UINT8 fieldArrayIndex,
                                const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldSINT32Value(const FIT_UINT8 fieldNum, const FIT_SINT32 value, const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT32Value(const FIT_UINT8 fieldNum, const FIT_UINT32 value, const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT32ZValue(const FIT_UINT8 fieldNum, const FIT_UINT32Z value, const FIT_UINT8 fieldArrayIndex,
                                const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldSINT64Value(const FIT_UINT8 fieldNum, const FIT_SINT64 value, const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT64Value(const FIT_UINT8 fieldNum, const FIT_UINT64 value, const FIT_UINT8 fieldArrayIndex,
                               const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldUINT64ZValue(const FIT_UINT8 fieldNum, const FIT_UINT64Z value, const FIT_UINT8 fieldArrayIndex,
                                const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldFLOAT32Value(const FIT_UINT8 fieldNum, const FIT_FLOAT32 value, const FIT_UINT8 fieldArrayIndex,
                                const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::SetFieldFLOAT64Value(const FIT_UINT8 fieldNum, const FIT_FLOAT64 value, const FIT_UINT8 fieldArrayIndex,
                                const FIT_UINT16 subFieldIndex) {
	if (!CanSupportSubField(fieldNum, subFieldIndex))
		return;
...
void Mesg::RemoveExpandedFields(void) {
	fields.erase(std::remove_if(fields.begin(), fields.end(), [](Field &field) { return field.GetIsExpanded(); }),
	             fields.end());
}
