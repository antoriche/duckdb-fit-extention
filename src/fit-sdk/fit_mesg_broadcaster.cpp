...
void MesgBroadcaster::RemoveListener(MesgDefinitionListener &mesgDefinitionListener) {
	mesgDefinitionListeners.erase(
	    std::find(mesgDefinitionListeners.begin(), mesgDefinitionListeners.end(), &mesgDefinitionListener));
}
...
void MesgBroadcaster::RemoveListener(FileIdMesgListener &fileIdMesgListener) {
	std::vector<FileIdMesgListener *>::iterator it =
	    std::find(fileIdMesgListeners.begin(), fileIdMesgListeners.end(), &fileIdMesgListener);
...
void MesgBroadcaster::RemoveListener(FileCreatorMesgListener &fileCreatorMesgListener) {
	std::vector<FileCreatorMesgListener *>::iterator it =
	    std::find(fileCreatorMesgListeners.begin(), fileCreatorMesgListeners.end(), &fileCreatorMesgListener);
...
void MesgBroadcaster::RemoveListener(TimestampCorrelationMesgListener &timestampCorrelationMesgListener) {
	std::vector<TimestampCorrelationMesgListener *>::iterator it =
	    std::find(timestampCorrelationMesgListeners.begin(), timestampCorrelationMesgListeners.end(),
	              &timestampCorrelationMesgListener);
...
void MesgBroadcaster::RemoveListener(SoftwareMesgListener &softwareMesgListener) {
	std::vector<SoftwareMesgListener *>::iterator it =
	    std::find(softwareMesgListeners.begin(), softwareMesgListeners.end(), &softwareMesgListener);
...
void MesgBroadcaster::RemoveListener(SlaveDeviceMesgListener &slaveDeviceMesgListener) {
	std::vector<SlaveDeviceMesgListener *>::iterator it =
	    std::find(slaveDeviceMesgListeners.begin(), slaveDeviceMesgListeners.end(), &slaveDeviceMesgListener);
...
void MesgBroadcaster::RemoveListener(CapabilitiesMesgListener &capabilitiesMesgListener) {
	std::vector<CapabilitiesMesgListener *>::iterator it =
	    std::find(capabilitiesMesgListeners.begin(), capabilitiesMesgListeners.end(), &capabilitiesMesgListener);
...
void MesgBroadcaster::RemoveListener(FileCapabilitiesMesgListener &fileCapabilitiesMesgListener) {
	std::vector<FileCapabilitiesMesgListener *>::iterator it = std::find(
	    fileCapabilitiesMesgListeners.begin(), fileCapabilitiesMesgListeners.end(), &fileCapabilitiesMesgListener);
...
void MesgBroadcaster::RemoveListener(MesgCapabilitiesMesgListener &mesgCapabilitiesMesgListener) {
	std::vector<MesgCapabilitiesMesgListener *>::iterator it = std::find(
	    mesgCapabilitiesMesgListeners.begin(), mesgCapabilitiesMesgListeners.end(), &mesgCapabilitiesMesgListener);
...
void MesgBroadcaster::RemoveListener(FieldCapabilitiesMesgListener &fieldCapabilitiesMesgListener) {
	std::vector<FieldCapabilitiesMesgListener *>::iterator it = std::find(
	    fieldCapabilitiesMesgListeners.begin(), fieldCapabilitiesMesgListeners.end(), &fieldCapabilitiesMesgListener);
...
void MesgBroadcaster::RemoveListener(DeviceSettingsMesgListener &deviceSettingsMesgListener) {
	std::vector<DeviceSettingsMesgListener *>::iterator it =
	    std::find(deviceSettingsMesgListeners.begin(), deviceSettingsMesgListeners.end(), &deviceSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(UserProfileMesgListener &userProfileMesgListener) {
	std::vector<UserProfileMesgListener *>::iterator it =
	    std::find(userProfileMesgListeners.begin(), userProfileMesgListeners.end(), &userProfileMesgListener);
...
void MesgBroadcaster::RemoveListener(HrmProfileMesgListener &hrmProfileMesgListener) {
	std::vector<HrmProfileMesgListener *>::iterator it =
	    std::find(hrmProfileMesgListeners.begin(), hrmProfileMesgListeners.end(), &hrmProfileMesgListener);
...
void MesgBroadcaster::RemoveListener(SdmProfileMesgListener &sdmProfileMesgListener) {
	std::vector<SdmProfileMesgListener *>::iterator it =
	    std::find(sdmProfileMesgListeners.begin(), sdmProfileMesgListeners.end(), &sdmProfileMesgListener);
...
void MesgBroadcaster::RemoveListener(BikeProfileMesgListener &bikeProfileMesgListener) {
	std::vector<BikeProfileMesgListener *>::iterator it =
	    std::find(bikeProfileMesgListeners.begin(), bikeProfileMesgListeners.end(), &bikeProfileMesgListener);
...
void MesgBroadcaster::RemoveListener(ConnectivityMesgListener &connectivityMesgListener) {
	std::vector<ConnectivityMesgListener *>::iterator it =
	    std::find(connectivityMesgListeners.begin(), connectivityMesgListeners.end(), &connectivityMesgListener);
...
void MesgBroadcaster::RemoveListener(WatchfaceSettingsMesgListener &watchfaceSettingsMesgListener) {
	std::vector<WatchfaceSettingsMesgListener *>::iterator it = std::find(
	    watchfaceSettingsMesgListeners.begin(), watchfaceSettingsMesgListeners.end(), &watchfaceSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(OhrSettingsMesgListener &ohrSettingsMesgListener) {
	std::vector<OhrSettingsMesgListener *>::iterator it =
	    std::find(ohrSettingsMesgListeners.begin(), ohrSettingsMesgListeners.end(), &ohrSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(TimeInZoneMesgListener &timeInZoneMesgListener) {
	std::vector<TimeInZoneMesgListener *>::iterator it =
	    std::find(timeInZoneMesgListeners.begin(), timeInZoneMesgListeners.end(), &timeInZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(ZonesTargetMesgListener &zonesTargetMesgListener) {
	std::vector<ZonesTargetMesgListener *>::iterator it =
	    std::find(zonesTargetMesgListeners.begin(), zonesTargetMesgListeners.end(), &zonesTargetMesgListener);
...
void MesgBroadcaster::RemoveListener(SportMesgListener &sportMesgListener) {
	std::vector<SportMesgListener *>::iterator it =
	    std::find(sportMesgListeners.begin(), sportMesgListeners.end(), &sportMesgListener);
...
void MesgBroadcaster::RemoveListener(HrZoneMesgListener &hrZoneMesgListener) {
	std::vector<HrZoneMesgListener *>::iterator it =
	    std::find(hrZoneMesgListeners.begin(), hrZoneMesgListeners.end(), &hrZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(SpeedZoneMesgListener &speedZoneMesgListener) {
	std::vector<SpeedZoneMesgListener *>::iterator it =
	    std::find(speedZoneMesgListeners.begin(), speedZoneMesgListeners.end(), &speedZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(CadenceZoneMesgListener &cadenceZoneMesgListener) {
	std::vector<CadenceZoneMesgListener *>::iterator it =
	    std::find(cadenceZoneMesgListeners.begin(), cadenceZoneMesgListeners.end(), &cadenceZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(PowerZoneMesgListener &powerZoneMesgListener) {
	std::vector<PowerZoneMesgListener *>::iterator it =
	    std::find(powerZoneMesgListeners.begin(), powerZoneMesgListeners.end(), &powerZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(MetZoneMesgListener &metZoneMesgListener) {
	std::vector<MetZoneMesgListener *>::iterator it =
	    std::find(metZoneMesgListeners.begin(), metZoneMesgListeners.end(), &metZoneMesgListener);
...
void MesgBroadcaster::RemoveListener(TrainingSettingsMesgListener &trainingSettingsMesgListener) {
	std::vector<TrainingSettingsMesgListener *>::iterator it = std::find(
	    trainingSettingsMesgListeners.begin(), trainingSettingsMesgListeners.end(), &trainingSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveSettingsMesgListener &diveSettingsMesgListener) {
	std::vector<DiveSettingsMesgListener *>::iterator it =
	    std::find(diveSettingsMesgListeners.begin(), diveSettingsMesgListeners.end(), &diveSettingsMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveAlarmMesgListener &diveAlarmMesgListener) {
	std::vector<DiveAlarmMesgListener *>::iterator it =
	    std::find(diveAlarmMesgListeners.begin(), diveAlarmMesgListeners.end(), &diveAlarmMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveApneaAlarmMesgListener &diveApneaAlarmMesgListener) {
	std::vector<DiveApneaAlarmMesgListener *>::iterator it =
	    std::find(diveApneaAlarmMesgListeners.begin(), diveApneaAlarmMesgListeners.end(), &diveApneaAlarmMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveGasMesgListener &diveGasMesgListener) {
	std::vector<DiveGasMesgListener *>::iterator it =
	    std::find(diveGasMesgListeners.begin(), diveGasMesgListeners.end(), &diveGasMesgListener);
...
void MesgBroadcaster::RemoveListener(GoalMesgListener &goalMesgListener) {
	std::vector<GoalMesgListener *>::iterator it =
	    std::find(goalMesgListeners.begin(), goalMesgListeners.end(), &goalMesgListener);
...
void MesgBroadcaster::RemoveListener(ActivityMesgListener &activityMesgListener) {
	std::vector<ActivityMesgListener *>::iterator it =
	    std::find(activityMesgListeners.begin(), activityMesgListeners.end(), &activityMesgListener);
...
void MesgBroadcaster::RemoveListener(SessionMesgListener &sessionMesgListener) {
	std::vector<SessionMesgListener *>::iterator it =
	    std::find(sessionMesgListeners.begin(), sessionMesgListeners.end(), &sessionMesgListener);
...
void MesgBroadcaster::RemoveListener(LapMesgListener &lapMesgListener) {
	std::vector<LapMesgListener *>::iterator it =
	    std::find(lapMesgListeners.begin(), lapMesgListeners.end(), &lapMesgListener);
...
void MesgBroadcaster::RemoveListener(LengthMesgListener &lengthMesgListener) {
	std::vector<LengthMesgListener *>::iterator it =
	    std::find(lengthMesgListeners.begin(), lengthMesgListeners.end(), &lengthMesgListener);
...
void MesgBroadcaster::RemoveListener(RecordMesgListener &recordMesgListener) {
	std::vector<RecordMesgListener *>::iterator it =
	    std::find(recordMesgListeners.begin(), recordMesgListeners.end(), &recordMesgListener);
...
void MesgBroadcaster::RemoveListener(EventMesgListener &eventMesgListener) {
	std::vector<EventMesgListener *>::iterator it =
	    std::find(eventMesgListeners.begin(), eventMesgListeners.end(), &eventMesgListener);
...
void MesgBroadcaster::RemoveListener(DeviceInfoMesgListener &deviceInfoMesgListener) {
	std::vector<DeviceInfoMesgListener *>::iterator it =
	    std::find(deviceInfoMesgListeners.begin(), deviceInfoMesgListeners.end(), &deviceInfoMesgListener);
...
void MesgBroadcaster::RemoveListener(DeviceAuxBatteryInfoMesgListener &deviceAuxBatteryInfoMesgListener) {
	std::vector<DeviceAuxBatteryInfoMesgListener *>::iterator it =
	    std::find(deviceAuxBatteryInfoMesgListeners.begin(), deviceAuxBatteryInfoMesgListeners.end(),
	              &deviceAuxBatteryInfoMesgListener);
...
void MesgBroadcaster::RemoveListener(TrainingFileMesgListener &trainingFileMesgListener) {
	std::vector<TrainingFileMesgListener *>::iterator it =
	    std::find(trainingFileMesgListeners.begin(), trainingFileMesgListeners.end(), &trainingFileMesgListener);
...
void MesgBroadcaster::RemoveListener(WeatherConditionsMesgListener &weatherConditionsMesgListener) {
	std::vector<WeatherConditionsMesgListener *>::iterator it = std::find(
	    weatherConditionsMesgListeners.begin(), weatherConditionsMesgListeners.end(), &weatherConditionsMesgListener);
...
void MesgBroadcaster::RemoveListener(WeatherAlertMesgListener &weatherAlertMesgListener) {
	std::vector<WeatherAlertMesgListener *>::iterator it =
	    std::find(weatherAlertMesgListeners.begin(), weatherAlertMesgListeners.end(), &weatherAlertMesgListener);
...
void MesgBroadcaster::RemoveListener(GpsMetadataMesgListener &gpsMetadataMesgListener) {
	std::vector<GpsMetadataMesgListener *>::iterator it =
	    std::find(gpsMetadataMesgListeners.begin(), gpsMetadataMesgListeners.end(), &gpsMetadataMesgListener);
...
void MesgBroadcaster::RemoveListener(CameraEventMesgListener &cameraEventMesgListener) {
	std::vector<CameraEventMesgListener *>::iterator it =
	    std::find(cameraEventMesgListeners.begin(), cameraEventMesgListeners.end(), &cameraEventMesgListener);
...
void MesgBroadcaster::RemoveListener(GyroscopeDataMesgListener &gyroscopeDataMesgListener) {
	std::vector<GyroscopeDataMesgListener *>::iterator it =
	    std::find(gyroscopeDataMesgListeners.begin(), gyroscopeDataMesgListeners.end(), &gyroscopeDataMesgListener);
...
void MesgBroadcaster::RemoveListener(AccelerometerDataMesgListener &accelerometerDataMesgListener) {
	std::vector<AccelerometerDataMesgListener *>::iterator it = std::find(
	    accelerometerDataMesgListeners.begin(), accelerometerDataMesgListeners.end(), &accelerometerDataMesgListener);
...
void MesgBroadcaster::RemoveListener(MagnetometerDataMesgListener &magnetometerDataMesgListener) {
	std::vector<MagnetometerDataMesgListener *>::iterator it = std::find(
	    magnetometerDataMesgListeners.begin(), magnetometerDataMesgListeners.end(), &magnetometerDataMesgListener);
...
void MesgBroadcaster::RemoveListener(BarometerDataMesgListener &barometerDataMesgListener) {
	std::vector<BarometerDataMesgListener *>::iterator it =
	    std::find(barometerDataMesgListeners.begin(), barometerDataMesgListeners.end(), &barometerDataMesgListener);
...
void MesgBroadcaster::RemoveListener(ThreeDSensorCalibrationMesgListener &threeDSensorCalibrationMesgListener) {
	std::vector<ThreeDSensorCalibrationMesgListener *>::iterator it =
	    std::find(threeDSensorCalibrationMesgListeners.begin(), threeDSensorCalibrationMesgListeners.end(),
	              &threeDSensorCalibrationMesgListener);
...
void MesgBroadcaster::RemoveListener(OneDSensorCalibrationMesgListener &oneDSensorCalibrationMesgListener) {
	std::vector<OneDSensorCalibrationMesgListener *>::iterator it =
	    std::find(oneDSensorCalibrationMesgListeners.begin(), oneDSensorCalibrationMesgListeners.end(),
	              &oneDSensorCalibrationMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoFrameMesgListener &videoFrameMesgListener) {
	std::vector<VideoFrameMesgListener *>::iterator it =
	    std::find(videoFrameMesgListeners.begin(), videoFrameMesgListeners.end(), &videoFrameMesgListener);
...
void MesgBroadcaster::RemoveListener(ObdiiDataMesgListener &obdiiDataMesgListener) {
	std::vector<ObdiiDataMesgListener *>::iterator it =
	    std::find(obdiiDataMesgListeners.begin(), obdiiDataMesgListeners.end(), &obdiiDataMesgListener);
...
void MesgBroadcaster::RemoveListener(NmeaSentenceMesgListener &nmeaSentenceMesgListener) {
	std::vector<NmeaSentenceMesgListener *>::iterator it =
	    std::find(nmeaSentenceMesgListeners.begin(), nmeaSentenceMesgListeners.end(), &nmeaSentenceMesgListener);
...
void MesgBroadcaster::RemoveListener(AviationAttitudeMesgListener &aviationAttitudeMesgListener) {
	std::vector<AviationAttitudeMesgListener *>::iterator it = std::find(
	    aviationAttitudeMesgListeners.begin(), aviationAttitudeMesgListeners.end(), &aviationAttitudeMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoMesgListener &videoMesgListener) {
	std::vector<VideoMesgListener *>::iterator it =
	    std::find(videoMesgListeners.begin(), videoMesgListeners.end(), &videoMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoTitleMesgListener &videoTitleMesgListener) {
	std::vector<VideoTitleMesgListener *>::iterator it =
	    std::find(videoTitleMesgListeners.begin(), videoTitleMesgListeners.end(), &videoTitleMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoDescriptionMesgListener &videoDescriptionMesgListener) {
	std::vector<VideoDescriptionMesgListener *>::iterator it = std::find(
	    videoDescriptionMesgListeners.begin(), videoDescriptionMesgListeners.end(), &videoDescriptionMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoClipMesgListener &videoClipMesgListener) {
	std::vector<VideoClipMesgListener *>::iterator it =
	    std::find(videoClipMesgListeners.begin(), videoClipMesgListeners.end(), &videoClipMesgListener);
...
void MesgBroadcaster::RemoveListener(SetMesgListener &setMesgListener) {
	std::vector<SetMesgListener *>::iterator it =
	    std::find(setMesgListeners.begin(), setMesgListeners.end(), &setMesgListener);
...
void MesgBroadcaster::RemoveListener(JumpMesgListener &jumpMesgListener) {
	std::vector<JumpMesgListener *>::iterator it =
	    std::find(jumpMesgListeners.begin(), jumpMesgListeners.end(), &jumpMesgListener);
...
void MesgBroadcaster::RemoveListener(SplitMesgListener &splitMesgListener) {
	std::vector<SplitMesgListener *>::iterator it =
	    std::find(splitMesgListeners.begin(), splitMesgListeners.end(), &splitMesgListener);
...
void MesgBroadcaster::RemoveListener(SplitSummaryMesgListener &splitSummaryMesgListener) {
	std::vector<SplitSummaryMesgListener *>::iterator it =
	    std::find(splitSummaryMesgListeners.begin(), splitSummaryMesgListeners.end(), &splitSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(ClimbProMesgListener &climbProMesgListener) {
	std::vector<ClimbProMesgListener *>::iterator it =
	    std::find(climbProMesgListeners.begin(), climbProMesgListeners.end(), &climbProMesgListener);
...
void MesgBroadcaster::RemoveListener(FieldDescriptionMesgListener &fieldDescriptionMesgListener) {
	std::vector<FieldDescriptionMesgListener *>::iterator it = std::find(
	    fieldDescriptionMesgListeners.begin(), fieldDescriptionMesgListeners.end(), &fieldDescriptionMesgListener);
...
void MesgBroadcaster::RemoveListener(DeveloperDataIdMesgListener &developerDataIdMesgListener) {
	std::vector<DeveloperDataIdMesgListener *>::iterator it = std::find(
	    developerDataIdMesgListeners.begin(), developerDataIdMesgListeners.end(), &developerDataIdMesgListener);
...
void MesgBroadcaster::RemoveListener(CourseMesgListener &courseMesgListener) {
	std::vector<CourseMesgListener *>::iterator it =
	    std::find(courseMesgListeners.begin(), courseMesgListeners.end(), &courseMesgListener);
...
void MesgBroadcaster::RemoveListener(CoursePointMesgListener &coursePointMesgListener) {
	std::vector<CoursePointMesgListener *>::iterator it =
	    std::find(coursePointMesgListeners.begin(), coursePointMesgListeners.end(), &coursePointMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentIdMesgListener &segmentIdMesgListener) {
	std::vector<SegmentIdMesgListener *>::iterator it =
	    std::find(segmentIdMesgListeners.begin(), segmentIdMesgListeners.end(), &segmentIdMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentLeaderboardEntryMesgListener &segmentLeaderboardEntryMesgListener) {
	std::vector<SegmentLeaderboardEntryMesgListener *>::iterator it =
	    std::find(segmentLeaderboardEntryMesgListeners.begin(), segmentLeaderboardEntryMesgListeners.end(),
	              &segmentLeaderboardEntryMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentPointMesgListener &segmentPointMesgListener) {
	std::vector<SegmentPointMesgListener *>::iterator it =
	    std::find(segmentPointMesgListeners.begin(), segmentPointMesgListeners.end(), &segmentPointMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentLapMesgListener &segmentLapMesgListener) {
	std::vector<SegmentLapMesgListener *>::iterator it =
	    std::find(segmentLapMesgListeners.begin(), segmentLapMesgListeners.end(), &segmentLapMesgListener);
...
void MesgBroadcaster::RemoveListener(SegmentFileMesgListener &segmentFileMesgListener) {
	std::vector<SegmentFileMesgListener *>::iterator it =
	    std::find(segmentFileMesgListeners.begin(), segmentFileMesgListeners.end(), &segmentFileMesgListener);
...
void MesgBroadcaster::RemoveListener(WorkoutMesgListener &workoutMesgListener) {
	std::vector<WorkoutMesgListener *>::iterator it =
	    std::find(workoutMesgListeners.begin(), workoutMesgListeners.end(), &workoutMesgListener);
...
void MesgBroadcaster::RemoveListener(WorkoutSessionMesgListener &workoutSessionMesgListener) {
	std::vector<WorkoutSessionMesgListener *>::iterator it =
	    std::find(workoutSessionMesgListeners.begin(), workoutSessionMesgListeners.end(), &workoutSessionMesgListener);
...
void MesgBroadcaster::RemoveListener(WorkoutStepMesgListener &workoutStepMesgListener) {
	std::vector<WorkoutStepMesgListener *>::iterator it =
	    std::find(workoutStepMesgListeners.begin(), workoutStepMesgListeners.end(), &workoutStepMesgListener);
...
void MesgBroadcaster::RemoveListener(ExerciseTitleMesgListener &exerciseTitleMesgListener) {
	std::vector<ExerciseTitleMesgListener *>::iterator it =
	    std::find(exerciseTitleMesgListeners.begin(), exerciseTitleMesgListeners.end(), &exerciseTitleMesgListener);
...
void MesgBroadcaster::RemoveListener(ScheduleMesgListener &scheduleMesgListener) {
	std::vector<ScheduleMesgListener *>::iterator it =
	    std::find(scheduleMesgListeners.begin(), scheduleMesgListeners.end(), &scheduleMesgListener);
...
void MesgBroadcaster::RemoveListener(TotalsMesgListener &totalsMesgListener) {
	std::vector<TotalsMesgListener *>::iterator it =
	    std::find(totalsMesgListeners.begin(), totalsMesgListeners.end(), &totalsMesgListener);
...
void MesgBroadcaster::RemoveListener(WeightScaleMesgListener &weightScaleMesgListener) {
	std::vector<WeightScaleMesgListener *>::iterator it =
	    std::find(weightScaleMesgListeners.begin(), weightScaleMesgListeners.end(), &weightScaleMesgListener);
...
void MesgBroadcaster::RemoveListener(BloodPressureMesgListener &bloodPressureMesgListener) {
	std::vector<BloodPressureMesgListener *>::iterator it =
	    std::find(bloodPressureMesgListeners.begin(), bloodPressureMesgListeners.end(), &bloodPressureMesgListener);
...
void MesgBroadcaster::RemoveListener(MonitoringInfoMesgListener &monitoringInfoMesgListener) {
	std::vector<MonitoringInfoMesgListener *>::iterator it =
	    std::find(monitoringInfoMesgListeners.begin(), monitoringInfoMesgListeners.end(), &monitoringInfoMesgListener);
...
void MesgBroadcaster::RemoveListener(MonitoringMesgListener &monitoringMesgListener) {
	std::vector<MonitoringMesgListener *>::iterator it =
	    std::find(monitoringMesgListeners.begin(), monitoringMesgListeners.end(), &monitoringMesgListener);
...
void MesgBroadcaster::RemoveListener(MonitoringHrDataMesgListener &monitoringHrDataMesgListener) {
	std::vector<MonitoringHrDataMesgListener *>::iterator it = std::find(
	    monitoringHrDataMesgListeners.begin(), monitoringHrDataMesgListeners.end(), &monitoringHrDataMesgListener);
...
void MesgBroadcaster::RemoveListener(Spo2DataMesgListener &spo2DataMesgListener) {
	std::vector<Spo2DataMesgListener *>::iterator it =
	    std::find(spo2DataMesgListeners.begin(), spo2DataMesgListeners.end(), &spo2DataMesgListener);
...
void MesgBroadcaster::RemoveListener(HrMesgListener &hrMesgListener) {
	std::vector<HrMesgListener *>::iterator it =
	    std::find(hrMesgListeners.begin(), hrMesgListeners.end(), &hrMesgListener);
...
void MesgBroadcaster::RemoveListener(StressLevelMesgListener &stressLevelMesgListener) {
	std::vector<StressLevelMesgListener *>::iterator it =
	    std::find(stressLevelMesgListeners.begin(), stressLevelMesgListeners.end(), &stressLevelMesgListener);
...
void MesgBroadcaster::RemoveListener(MaxMetDataMesgListener &maxMetDataMesgListener) {
	std::vector<MaxMetDataMesgListener *>::iterator it =
	    std::find(maxMetDataMesgListeners.begin(), maxMetDataMesgListeners.end(), &maxMetDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaBodyBatteryDataMesgListener &hsaBodyBatteryDataMesgListener) {
	std::vector<HsaBodyBatteryDataMesgListener *>::iterator it =
	    std::find(hsaBodyBatteryDataMesgListeners.begin(), hsaBodyBatteryDataMesgListeners.end(),
	              &hsaBodyBatteryDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaEventMesgListener &hsaEventMesgListener) {
	std::vector<HsaEventMesgListener *>::iterator it =
	    std::find(hsaEventMesgListeners.begin(), hsaEventMesgListeners.end(), &hsaEventMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaAccelerometerDataMesgListener &hsaAccelerometerDataMesgListener) {
	std::vector<HsaAccelerometerDataMesgListener *>::iterator it =
	    std::find(hsaAccelerometerDataMesgListeners.begin(), hsaAccelerometerDataMesgListeners.end(),
	              &hsaAccelerometerDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaGyroscopeDataMesgListener &hsaGyroscopeDataMesgListener) {
	std::vector<HsaGyroscopeDataMesgListener *>::iterator it = std::find(
	    hsaGyroscopeDataMesgListeners.begin(), hsaGyroscopeDataMesgListeners.end(), &hsaGyroscopeDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaStepDataMesgListener &hsaStepDataMesgListener) {
	std::vector<HsaStepDataMesgListener *>::iterator it =
	    std::find(hsaStepDataMesgListeners.begin(), hsaStepDataMesgListeners.end(), &hsaStepDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaSpo2DataMesgListener &hsaSpo2DataMesgListener) {
	std::vector<HsaSpo2DataMesgListener *>::iterator it =
	    std::find(hsaSpo2DataMesgListeners.begin(), hsaSpo2DataMesgListeners.end(), &hsaSpo2DataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaStressDataMesgListener &hsaStressDataMesgListener) {
	std::vector<HsaStressDataMesgListener *>::iterator it =
	    std::find(hsaStressDataMesgListeners.begin(), hsaStressDataMesgListeners.end(), &hsaStressDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaRespirationDataMesgListener &hsaRespirationDataMesgListener) {
	std::vector<HsaRespirationDataMesgListener *>::iterator it =
	    std::find(hsaRespirationDataMesgListeners.begin(), hsaRespirationDataMesgListeners.end(),
	              &hsaRespirationDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaHeartRateDataMesgListener &hsaHeartRateDataMesgListener) {
	std::vector<HsaHeartRateDataMesgListener *>::iterator it = std::find(
	    hsaHeartRateDataMesgListeners.begin(), hsaHeartRateDataMesgListeners.end(), &hsaHeartRateDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaConfigurationDataMesgListener &hsaConfigurationDataMesgListener) {
	std::vector<HsaConfigurationDataMesgListener *>::iterator it =
	    std::find(hsaConfigurationDataMesgListeners.begin(), hsaConfigurationDataMesgListeners.end(),
	              &hsaConfigurationDataMesgListener);
...
void MesgBroadcaster::RemoveListener(HsaWristTemperatureDataMesgListener &hsaWristTemperatureDataMesgListener) {
	std::vector<HsaWristTemperatureDataMesgListener *>::iterator it =
	    std::find(hsaWristTemperatureDataMesgListeners.begin(), hsaWristTemperatureDataMesgListeners.end(),
	              &hsaWristTemperatureDataMesgListener);
...
void MesgBroadcaster::RemoveListener(MemoGlobMesgListener &memoGlobMesgListener) {
	std::vector<MemoGlobMesgListener *>::iterator it =
	    std::find(memoGlobMesgListeners.begin(), memoGlobMesgListeners.end(), &memoGlobMesgListener);
...
void MesgBroadcaster::RemoveListener(SleepLevelMesgListener &sleepLevelMesgListener) {
	std::vector<SleepLevelMesgListener *>::iterator it =
	    std::find(sleepLevelMesgListeners.begin(), sleepLevelMesgListeners.end(), &sleepLevelMesgListener);
...
void MesgBroadcaster::RemoveListener(AntChannelIdMesgListener &antChannelIdMesgListener) {
	std::vector<AntChannelIdMesgListener *>::iterator it =
	    std::find(antChannelIdMesgListeners.begin(), antChannelIdMesgListeners.end(), &antChannelIdMesgListener);
...
void MesgBroadcaster::RemoveListener(AntRxMesgListener &antRxMesgListener) {
	std::vector<AntRxMesgListener *>::iterator it =
	    std::find(antRxMesgListeners.begin(), antRxMesgListeners.end(), &antRxMesgListener);
...
void MesgBroadcaster::RemoveListener(AntTxMesgListener &antTxMesgListener) {
	std::vector<AntTxMesgListener *>::iterator it =
	    std::find(antTxMesgListeners.begin(), antTxMesgListeners.end(), &antTxMesgListener);
...
void MesgBroadcaster::RemoveListener(ExdScreenConfigurationMesgListener &exdScreenConfigurationMesgListener) {
	std::vector<ExdScreenConfigurationMesgListener *>::iterator it =
	    std::find(exdScreenConfigurationMesgListeners.begin(), exdScreenConfigurationMesgListeners.end(),
	              &exdScreenConfigurationMesgListener);
...
void MesgBroadcaster::RemoveListener(ExdDataFieldConfigurationMesgListener &exdDataFieldConfigurationMesgListener) {
	std::vector<ExdDataFieldConfigurationMesgListener *>::iterator it =
	    std::find(exdDataFieldConfigurationMesgListeners.begin(), exdDataFieldConfigurationMesgListeners.end(),
	              &exdDataFieldConfigurationMesgListener);
...
void MesgBroadcaster::RemoveListener(ExdDataConceptConfigurationMesgListener &exdDataConceptConfigurationMesgListener) {
	std::vector<ExdDataConceptConfigurationMesgListener *>::iterator it =
	    std::find(exdDataConceptConfigurationMesgListeners.begin(), exdDataConceptConfigurationMesgListeners.end(),
	              &exdDataConceptConfigurationMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveSummaryMesgListener &diveSummaryMesgListener) {
	std::vector<DiveSummaryMesgListener *>::iterator it =
	    std::find(diveSummaryMesgListeners.begin(), diveSummaryMesgListeners.end(), &diveSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(AadAccelFeaturesMesgListener &aadAccelFeaturesMesgListener) {
	std::vector<AadAccelFeaturesMesgListener *>::iterator it = std::find(
	    aadAccelFeaturesMesgListeners.begin(), aadAccelFeaturesMesgListeners.end(), &aadAccelFeaturesMesgListener);
...
void MesgBroadcaster::RemoveListener(HrvMesgListener &hrvMesgListener) {
	std::vector<HrvMesgListener *>::iterator it =
	    std::find(hrvMesgListeners.begin(), hrvMesgListeners.end(), &hrvMesgListener);
...
void MesgBroadcaster::RemoveListener(BeatIntervalsMesgListener &beatIntervalsMesgListener) {
	std::vector<BeatIntervalsMesgListener *>::iterator it =
	    std::find(beatIntervalsMesgListeners.begin(), beatIntervalsMesgListeners.end(), &beatIntervalsMesgListener);
...
void MesgBroadcaster::RemoveListener(HrvStatusSummaryMesgListener &hrvStatusSummaryMesgListener) {
	std::vector<HrvStatusSummaryMesgListener *>::iterator it = std::find(
	    hrvStatusSummaryMesgListeners.begin(), hrvStatusSummaryMesgListeners.end(), &hrvStatusSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(HrvValueMesgListener &hrvValueMesgListener) {
	std::vector<HrvValueMesgListener *>::iterator it =
	    std::find(hrvValueMesgListeners.begin(), hrvValueMesgListeners.end(), &hrvValueMesgListener);
...
void MesgBroadcaster::RemoveListener(RawBbiMesgListener &rawBbiMesgListener) {
	std::vector<RawBbiMesgListener *>::iterator it =
	    std::find(rawBbiMesgListeners.begin(), rawBbiMesgListeners.end(), &rawBbiMesgListener);
...
void MesgBroadcaster::RemoveListener(RespirationRateMesgListener &respirationRateMesgListener) {
	std::vector<RespirationRateMesgListener *>::iterator it = std::find(
	    respirationRateMesgListeners.begin(), respirationRateMesgListeners.end(), &respirationRateMesgListener);
...
void MesgBroadcaster::RemoveListener(ChronoShotSessionMesgListener &chronoShotSessionMesgListener) {
	std::vector<ChronoShotSessionMesgListener *>::iterator it = std::find(
	    chronoShotSessionMesgListeners.begin(), chronoShotSessionMesgListeners.end(), &chronoShotSessionMesgListener);
...
void MesgBroadcaster::RemoveListener(ChronoShotDataMesgListener &chronoShotDataMesgListener) {
	std::vector<ChronoShotDataMesgListener *>::iterator it =
	    std::find(chronoShotDataMesgListeners.begin(), chronoShotDataMesgListeners.end(), &chronoShotDataMesgListener);
...
void MesgBroadcaster::RemoveListener(TankUpdateMesgListener &tankUpdateMesgListener) {
	std::vector<TankUpdateMesgListener *>::iterator it =
	    std::find(tankUpdateMesgListeners.begin(), tankUpdateMesgListeners.end(), &tankUpdateMesgListener);
...
void MesgBroadcaster::RemoveListener(TankSummaryMesgListener &tankSummaryMesgListener) {
	std::vector<TankSummaryMesgListener *>::iterator it =
	    std::find(tankSummaryMesgListeners.begin(), tankSummaryMesgListeners.end(), &tankSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(SleepAssessmentMesgListener &sleepAssessmentMesgListener) {
	std::vector<SleepAssessmentMesgListener *>::iterator it = std::find(
	    sleepAssessmentMesgListeners.begin(), sleepAssessmentMesgListeners.end(), &sleepAssessmentMesgListener);
...
void MesgBroadcaster::RemoveListener(SkinTempOvernightMesgListener &skinTempOvernightMesgListener) {
	std::vector<SkinTempOvernightMesgListener *>::iterator it = std::find(
	    skinTempOvernightMesgListeners.begin(), skinTempOvernightMesgListeners.end(), &skinTempOvernightMesgListener);
...
void MesgBroadcaster::RemoveListener(PadMesgListener &padMesgListener) {
	std::vector<PadMesgListener *>::iterator it =
	    std::find(padMesgListeners.begin(), padMesgListeners.end(), &padMesgListener);
