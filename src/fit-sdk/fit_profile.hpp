...
#define FIT_FILE_WEIGHT                                                                                                \
	((FIT_FILE)9) // Read only, single file. Circular buffer. All message definitions at start of file. Directory=Weight
...
#define FIT_MESG_NUM_HSA_WRIST_TEMPERATURE_DATA                                                                        \
	((FIT_MESG_NUM)409)                                   // Message number for the HSA wrist temperature data message
...
#define FIT_CHECKSUM_CLEAR                                                                                             \
	((FIT_CHECKSUM)0) // Allows clear of checksum for flash memory where can only write 1 to 0 without erasing sector.
#define FIT_CHECKSUM_OK                                                                                                \
	((FIT_CHECKSUM)1) // Set to mark checksum as valid if computes to invalid values 0 or 0xFF. Checksum can also be set
	                  // to ok to save encoding computation time.
...
#define FIT_DATE_TIME_MIN                                                                                              \
	((FIT_DATE_TIME)0x10000000) // if date_time is < 0x10000000 then it is system time (seconds from device power on)
...
#define FIT_LOCAL_DATE_TIME_MIN                                                                                        \
	((FIT_LOCAL_DATE_TIME)0x10000000) // if date_time is < 0x10000000 then it is system time (seconds from device power
	                                  // on)
...
#define FIT_SUB_SPORT_OBSTACLE                                                                                         \
	((FIT_SUB_SPORT)59) // Used for events where participants run, crawl through mud, climb over walls, etc.
...
#define FIT_SESSION_TRIGGER_AUTO_MULTI_SPORT                                                                           \
	((FIT_SESSION_TRIGGER)2) // Auto multi-sport feature is enabled and user pressed lap button to advance session.
#define FIT_SESSION_TRIGGER_FITNESS_EQUIPMENT                                                                          \
	((FIT_SESSION_TRIGGER)3) // Auto sport change caused by user linking to fitness equipment.
...
#define FIT_EVENT_VIRTUAL_PARTNER_PACE                                                                                 \
	((FIT_EVENT)12) // Group 1. Start at beginning of activity if VP enabled, when VP pace is changed during activity or
	                // VP enabled mid activity. stop_disable when VP disabled.
...
#define FIT_EVENT_TIME_DURATION_ALERT                                                                                  \
	((FIT_EVENT)23) // Group 1. Start if enabled mid activity (not required at start of activity). Stop when duration is
	                // reached. stop_disable if disabled.
#define FIT_EVENT_DISTANCE_DURATION_ALERT                                                                              \
	((FIT_EVENT)24) // Group 1. Start if enabled mid activity (not required at start of activity). Stop when duration is
	                // reached. stop_disable if disabled.
#define FIT_EVENT_CALORIE_DURATION_ALERT                                                                               \
	((FIT_EVENT)25) // Group 1. Start if enabled mid activity (not required at start of activity). Stop when duration is
	                // reached. stop_disable if disabled.
...
#define FIT_GARMIN_PRODUCT_HRM_RUN_SINGLE_BYTE_PRODUCT_ID                                                              \
	((FIT_GARMIN_PRODUCT)8)                               // hrm_run model for HRM ANT+ messaging
...
#define FIT_GARMIN_PRODUCT_HRM_TRI_SINGLE_BYTE_PRODUCT_ID                                                              \
	((FIT_GARMIN_PRODUCT)12) // hrm_tri model for HRM ANT+ messaging
#define FIT_GARMIN_PRODUCT_HRM4_RUN_SINGLE_BYTE_PRODUCT_ID                                                             \
	((FIT_GARMIN_PRODUCT)13) // hrm4 run model for HRM ANT+ messaging
#define FIT_GARMIN_PRODUCT_FR225_SINGLE_BYTE_PRODUCT_ID ((FIT_GARMIN_PRODUCT)14) // fr225 model for HRM ANT+ messaging
#define FIT_GARMIN_PRODUCT_GEN3_BSM_SINGLE_BYTE_PRODUCT_ID                                                             \
	((FIT_GARMIN_PRODUCT)15) // gen3_bsm model for Bike Speed ANT+ messaging
#define FIT_GARMIN_PRODUCT_GEN3_BCM_SINGLE_BYTE_PRODUCT_ID                                                             \
	((FIT_GARMIN_PRODUCT)16) // gen3_bcm model for Bike Cadence ANT+ messaging
#define FIT_GARMIN_PRODUCT_HRM_FIT_SINGLE_BYTE_PRODUCT_ID ((FIT_GARMIN_PRODUCT)22)
#define FIT_GARMIN_PRODUCT_OHR                                                                                         \
	((FIT_GARMIN_PRODUCT)255) // Garmin Wearable Optical Heart Rate Sensor for ANT+ HR Profile Broadcasting
...
#define FIT_WORKOUT_CAPABILITIES_HEART_RATE                                                                            \
	((FIT_WORKOUT_CAPABILITIES)0x00000100) // Heart rate source required for workout step.
#define FIT_WORKOUT_CAPABILITIES_DISTANCE                                                                              \
	((FIT_WORKOUT_CAPABILITIES)0x00000200) // Distance source required for workout step.
#define FIT_WORKOUT_CAPABILITIES_CADENCE                                                                               \
	((FIT_WORKOUT_CAPABILITIES)0x00000400) // Cadence source required for workout step.
...
#define FIT_WORKOUT_CAPABILITIES_RESISTANCE                                                                            \
	((FIT_WORKOUT_CAPABILITIES)0x00002000) // Resistance source required for workout step.
...
#define FIT_COURSE_CAPABILITIES_AVIATION                                                                               \
	((FIT_COURSE_CAPABILITIES)0x00001000) // Denote course files to be used as flight plans
...
typedef FIT_UINT32
    FIT_WORKOUT_POWER; // 0 - 1000 indicates % of functional threshold power; >1000 indicates watts plus 1000.
...
#define FIT_SWIM_STROKE_IM                                                                                             \
	((FIT_SWIM_STROKE)6) // IM is a mixed interval containing the same number of lengths for each of: Butterfly,
	                     // Backstroke, Breaststroke, Freestyle, swam in that order.
#define FIT_SWIM_STROKE_IM_BY_ROUND                                                                                    \
	((FIT_SWIM_STROKE)7) // For repeated workout steps, a new individual medly stroke is used for each round.
...
#define FIT_CONNECTIVITY_CAPABILITIES_DEVICE_INITIATES_SYNC                                                            \
	((FIT_CONNECTIVITY_CAPABILITIES)0x00008000) // Indicates device is in control of initiating all syncs
...
#define FIT_CONNECTIVITY_CAPABILITIES_CONNECT_IQ_APP_MANAGMENT                                                         \
	((FIT_CONNECTIVITY_CAPABILITIES)0x00100000) // Device supports delete and reorder of apps via GCM
...
#define FIT_CONNECTIVITY_CAPABILITIES_INCIDENT_DETECTION                                                               \
	((FIT_CONNECTIVITY_CAPABILITIES)0x00800000) // Device supports incident detection
#define FIT_CONNECTIVITY_CAPABILITIES_AUDIO_PROMPTS ((FIT_CONNECTIVITY_CAPABILITIES)0x01000000)
#define FIT_CONNECTIVITY_CAPABILITIES_WIFI_VERIFICATION                                                                \
	((FIT_CONNECTIVITY_CAPABILITIES)0x02000000) // Device supports reporting wifi verification via GCM
#define FIT_CONNECTIVITY_CAPABILITIES_TRUE_UP ((FIT_CONNECTIVITY_CAPABILITIES)0x04000000) // Device supports True Up
#define FIT_CONNECTIVITY_CAPABILITIES_FIND_MY_WATCH                                                                    \
	((FIT_CONNECTIVITY_CAPABILITIES)0x08000000) // Device supports Find My Watch
#define FIT_CONNECTIVITY_CAPABILITIES_REMOTE_MANUAL_SYNC ((FIT_CONNECTIVITY_CAPABILITIES)0x10000000)
#define FIT_CONNECTIVITY_CAPABILITIES_LIVE_TRACK_AUTO_START                                                            \
	((FIT_CONNECTIVITY_CAPABILITIES)0x20000000) // Device supports LiveTrack auto start
#define FIT_CONNECTIVITY_CAPABILITIES_LIVE_TRACK_MESSAGING                                                             \
	((FIT_CONNECTIVITY_CAPABILITIES)0x40000000) // Device supports LiveTrack Messaging
#define FIT_CONNECTIVITY_CAPABILITIES_INSTANT_INPUT                                                                    \
	((FIT_CONNECTIVITY_CAPABILITIES)0x80000000) // Device supports instant input feature
...
#define FIT_BLE_DEVICE_TYPE_CONNECTED_GPS                                                                              \
	((FIT_BLE_DEVICE_TYPE)0) // GPS that is provided over a proprietary bluetooth service
...
#define FIT_CAMERA_EVENT_TYPE_VIDEO_SPLIT                                                                              \
	((FIT_CAMERA_EVENT_TYPE)1) // Mark of video file split (end of one file, beginning of the other)
...
#define FIT_COMM_TIMEOUT_TYPE_CONNECTION_TIMEOUT                                                                       \
...
#define FIT_EXD_LAYOUT_DYNAMIC                                                                                         \
	((FIT_EXD_LAYOUT)8) // The EXD may display the configured concepts in any layout it sees fit.
...
#define FIT_EXERCISE_CATEGORY_CARDIO_SENSORS                                                                           \
	((FIT_EXERCISE_CATEGORY)34) // Exercises within workouts that use GPS/sensors rather than rep counting
...
#define FIT_HIP_RAISE_EXERCISE_NAME_WEIGHTED_MARCHING_HIP_RAISE_WITH_FEET_ON_A_SWISS_BALL                              \
	((FIT_HIP_RAISE_EXERCISE_NAME)27)
...
#define FIT_HIP_RAISE_EXERCISE_NAME_WEIGHTED_SINGLE_LEG_HIP_RAISE_WITH_FOOT_ON_BOSU_BALL                               \
...
#define FIT_HIP_RAISE_EXERCISE_NAME_WEIGHTED_SINGLE_LEG_HIP_RAISE_WITH_FOOT_ON_FOAM_ROLLER                             \
	((FIT_HIP_RAISE_EXERCISE_NAME)37)
#define FIT_HIP_RAISE_EXERCISE_NAME_SINGLE_LEG_HIP_RAISE_WITH_FOOT_ON_MEDICINE_BALL ((FIT_HIP_RAISE_EXERCISE_NAME)38)
#define FIT_HIP_RAISE_EXERCISE_NAME_WEIGHTED_SINGLE_LEG_HIP_RAISE_WITH_FOOT_ON_MEDICINE_BALL                           \
	((FIT_HIP_RAISE_EXERCISE_NAME)39)
#define FIT_HIP_RAISE_EXERCISE_NAME_SINGLE_LEG_HIP_RAISE_WITH_HEAD_ON_BOSU_BALL ((FIT_HIP_RAISE_EXERCISE_NAME)40)
#define FIT_HIP_RAISE_EXERCISE_NAME_WEIGHTED_SINGLE_LEG_HIP_RAISE_WITH_HEAD_ON_BOSU_BALL                               \
	((FIT_HIP_RAISE_EXERCISE_NAME)41)
...
#define FIT_HYPEREXTENSION_EXERCISE_NAME_BACK_EXTENSION_WITH_OPPOSITE_ARM_AND_LEG_REACH                                \
	((FIT_HYPEREXTENSION_EXERCISE_NAME)0)
#define FIT_HYPEREXTENSION_EXERCISE_NAME_WEIGHTED_BACK_EXTENSION_WITH_OPPOSITE_ARM_AND_LEG_REACH                       \
	((FIT_HYPEREXTENSION_EXERCISE_NAME)1)
...
#define FIT_HYPEREXTENSION_EXERCISE_NAME_WEIGHTED_SWISS_BALL_OPPOSITE_ARM_AND_LEG_LIFT                                 \
	((FIT_HYPEREXTENSION_EXERCISE_NAME)36)
...
#define FIT_HYPEREXTENSION_EXERCISE_NAME_SUPINE_FLOOR_BARRE                                                            \
	((FIT_HYPEREXTENSION_EXERCISE_NAME)39) // Deprecated do not use
...
#define FIT_LATERAL_RAISE_EXERCISE_NAME_POLE_DOUBLE_ARM_OVERHEAD_AND_FORWARD_WHEELCHAIR                                \
	((FIT_LATERAL_RAISE_EXERCISE_NAME)40)
...
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_DUMBBELL_ALTERNATING_SHOULDER_PRESS_AND_TWIST                                 \
	((FIT_SHOULDER_PRESS_EXERCISE_NAME)6)
...
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_DUMBBELL_CURL_TO_OVERHEAD_PRESS_WHEELCHAIR                                    \
	((FIT_SHOULDER_PRESS_EXERCISE_NAME)29)
...
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_BENT_ARM_LATERAL_RAISE_AND_EXTERNAL_ROTATION                              \
	((FIT_SHOULDER_STABILITY_EXERCISE_NAME)3)
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_CABLE_EXTERNAL_ROTATION ((FIT_SHOULDER_STABILITY_EXERCISE_NAME)4)
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_DUMBBELL_FACE_PULL_WITH_EXTERNAL_ROTATION                                 \
	((FIT_SHOULDER_STABILITY_EXERCISE_NAME)5)
...
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_SEATED_DUMBBELL_EXTERNAL_ROTATION                                         \
	((FIT_SHOULDER_STABILITY_EXERCISE_NAME)23)
...
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_SEATED_DUMBBELL_INTERNAL_ROTATION                                         \
	((FIT_SHOULDER_STABILITY_EXERCISE_NAME)35)
...
#define FIT_TOTAL_BODY_EXERCISE_NAME_BURPEE_BOX_JUMP_OVER_YES_LITERALLY_JUMPING_OVER_THE_BOX                           \
	((FIT_TOTAL_BODY_EXERCISE_NAME)15)
...
#define FIT_MOVE_EXERCISE_NAME_PILATES_PLIE_SQUATS_PARALLEL_TURNED_OUT_FLAT_AND_HEELS_WITH_CHAIR                       \
...
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_INCLINE_EZ_BAR_LYING_TRICEPS_EXTENSION                                     \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)11)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_LYING_DUMBBELL_PULLOVER_TO_EXTENSION                                       \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)12)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_LYING_EZ_BAR_TRICEPS_EXTENSION ((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)13)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_LYING_TRICEPS_EXTENSION_TO_CLOSE_GRIP_BENCH_PRESS                          \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)14)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_OVERHEAD_DUMBBELL_TRICEPS_EXTENSION                                        \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)15)
...
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SEATED_BARBELL_OVERHEAD_TRICEPS_EXTENSION                                  \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)20)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SEATED_DUMBBELL_OVERHEAD_TRICEPS_EXTENSION                                 \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)21)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SEATED_EZ_BAR_OVERHEAD_TRICEPS_EXTENSION                                   \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)22)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SEATED_SINGLE_ARM_OVERHEAD_DUMBBELL_EXTENSION                              \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)23)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SINGLE_ARM_DUMBBELL_OVERHEAD_TRICEPS_EXTENSION                             \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)24)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SINGLE_DUMBBELL_SEATED_OVERHEAD_TRICEPS_EXTENSION                          \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)25)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SINGLE_LEG_BENCH_DIP_AND_KICK ((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)26)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_WEIGHTED_SINGLE_LEG_BENCH_DIP_AND_KICK                                     \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)27)
...
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SWISS_BALL_DUMBBELL_LYING_TRICEPS_EXTENSION                                \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)33)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SWISS_BALL_EZ_BAR_LYING_TRICEPS_EXTENSION                                  \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)34)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_SWISS_BALL_EZ_BAR_OVERHEAD_TRICEPS_EXTENSION                               \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)35)
...
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_ALTERNATING_DUMBBELL_LYING_TRICEPS_EXTENSION                               \
...
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_OVERHEAD_DUMBBELL_TRICEPS_EXTENSION_WHEELCHAIR                             \
	((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)44)
...
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_EXTERNAL_ROTATION_AT_90_DEGREE_ABDUCTION                                    \
	((FIT_BANDED_EXERCISES_EXERCISE_NAME)12)
...
#define FIT_SPLIT_TYPE_TRANSITION                                                                                      \
	((FIT_SPLIT_TYPE)23) // Marks the time going from ascent_split to descent_split/used in backcountry ski
...
#define FIT_GAS_CONSUMPTION_RATE_TYPE_PRESSURE_SAC                                                                     \
	((FIT_GAS_CONSUMPTION_RATE_TYPE)0) // Pressure-based Surface Air Consumption
...
public:
	...
	typedef enum { SPORT_MESG_SPORT, SPORT_MESG_SUB_SPORT, SPORT_MESG_NAME, SPORT_MESG_FIELDS } SPORT_MESG_FIELD_INDEX;
	...
	typedef enum { HRV_MESG_TIME, HRV_MESG_FIELDS } HRV_MESG_FIELD_INDEX;
	...
	typedef enum { HRV_VALUE_MESG_TIMESTAMP, HRV_VALUE_MESG_VALUE, HRV_VALUE_MESG_FIELDS } HRV_VALUE_MESG_FIELD_INDEX;
	...
	typedef enum { PAD_MESG_FIELDS } PAD_MESG_FIELD_INDEX;
	...
	static const FIT_UINT16 GetSubFieldIndex(const std::string &mesgName, const std::string &fieldName,
	                                         const std::string &subFieldName);
	static const Profile::SUBFIELD *GetSubField(const FIT_UINT16 mesgNum, const FIT_UINT8 fieldNum,
	                                            const FIT_UINT16 subFieldIndex);
	static const Profile::SUBFIELD *GetSubField(const std::string &mesgName, const std::string &fieldName,
	                                            const std::string &subFieldName);
};
