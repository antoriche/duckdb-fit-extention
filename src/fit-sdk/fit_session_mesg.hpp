...
public:
	...
	void SetAvgRunningCadence(FIT_UINT8 avgRunningCadence) {
		SetFieldUINT8Value(18, avgRunningCadence, 0,
		                   (FIT_UINT16)Profile::SESSION_MESG_AVG_CADENCE_FIELD_AVG_RUNNING_CADENCE);
	}
	...
	void SetMaxRunningCadence(FIT_UINT8 maxRunningCadence) {
		SetFieldUINT8Value(19, maxRunningCadence, 0,
		                   (FIT_UINT16)Profile::SESSION_MESG_MAX_CADENCE_FIELD_MAX_RUNNING_CADENCE);
	}
	...
	// Units: kGrit
	// Comment: The grit score estimates how challenging a route could be for a cyclist in terms of time spent going
	...
	// Units: Flow
	// Comment: The flow score estimates how long distance wise a cyclist deaccelerates over intervals where
	...
	// Comment: A 0-100 scale representing how a user felt while performing a workout. Low values are considered feeling
	// bad, while high values are good.
	///////////////////////////////////////////////////////////////////////
	...
	// Comment: Common Borg CR10 / 0-10 RPE scale, multiplied 10x.. Aggregate score for all workouts in a single
	// session.
	///////////////////////////////////////////////////////////////////////
	...
	// Units: mS
	// Comment: Standard deviation of R-R interval (SDRR) - Heart rate variability measure most useful for wellness
	// users.
	///////////////////////////////////////////////////////////////////////
