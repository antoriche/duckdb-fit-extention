...
#define UNICODE_IS_POINT_VALID(POINT)                                                                                  \
	((((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x00D7FF) ||                           \
	   (((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) >= (FIT_LARGE_TYPE)0x00E000)) &&                          \
	  (((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x10FFFF))                              \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))

// UTF-8 encoding.
#define UTF8_IS_UNIT_VALID(UNIT)                                                                                       \
	(((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFF) != (FIT_LARGE_TYPE)0xC0) &&                                     \
	  (((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFF) != (FIT_LARGE_TYPE)0xC1) &&                                     \
	  (((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFF) <= (FIT_LARGE_TYPE)0xF4))                                       \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF8_IS_UNIT_1UNIT(UNIT)                                                                                       \
	((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0x80) == (FIT_LARGE_TYPE)0x00) ? (FIT_TRUE) : (FIT_FALSE))
#define UTF8_IS_UNIT_2UNIT_LEAD(UNIT)                                                                                  \
	((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xE0) == (FIT_LARGE_TYPE)0xC0) ? (FIT_TRUE) : (FIT_FALSE))
#define UTF8_IS_UNIT_3UNIT_LEAD(UNIT)                                                                                  \
	((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xF0) == (FIT_LARGE_TYPE)0xE0) ? (FIT_TRUE) : (FIT_FALSE))
#define UTF8_IS_UNIT_4UNIT_LEAD(UNIT)                                                                                  \
	((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xF8) == (FIT_LARGE_TYPE)0xF0) ? (FIT_TRUE) : (FIT_FALSE))
#define UTF8_IS_UNIT_MULTI_CONT(UNIT)                                                                                  \
	((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xC0) == (FIT_LARGE_TYPE)0x80) ? (FIT_TRUE) : (FIT_FALSE))
#define UTF8_IS_POINT_1UNIT(POINT)                                                                                     \
	(((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x00007F)) ? (FIT_TRUE) : (FIT_FALSE))
#define UTF8_IS_POINT_2UNIT(POINT)                                                                                     \
	(((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) >= (FIT_LARGE_TYPE)0x000080) &&                            \
	  (((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x0007FF))                              \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF8_IS_POINT_3UNIT(POINT)                                                                                     \
	(((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) >= (FIT_LARGE_TYPE)0x000800) &&                            \
	  (((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x00FFFF))                              \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF8_IS_POINT_4UNIT(POINT)                                                                                     \
	(((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) >= (FIT_LARGE_TYPE)0x010000) &&                            \
	  (((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x10FFFF))                              \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF8_1UNIT_TO_POINT(UNIT) ((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0x7F) << 0))
#define UTF8_2UNIT_TO_POINT(LEAD, C1)                                                                                  \
	((((FIT_LARGE_TYPE)(LEAD) & (FIT_LARGE_TYPE)0x1F) << 6) | (((FIT_LARGE_TYPE)(C1) & (FIT_LARGE_TYPE)0x3F) << 0))
#define UTF8_3UNIT_TO_POINT(LEAD, C1, C2)                                                                              \
	((((FIT_LARGE_TYPE)(LEAD) & (FIT_LARGE_TYPE)0x0F) << 12) | (((FIT_LARGE_TYPE)(C1) & (FIT_LARGE_TYPE)0x3F) << 6) |  \
	 (((FIT_LARGE_TYPE)(C2) & (FIT_LARGE_TYPE)0x3F) << 0))
#define UTF8_4UNIT_TO_POINT(LEAD, C1, C2, C3)                                                                          \
	((((FIT_LARGE_TYPE)(LEAD) & (FIT_LARGE_TYPE)0x07) << 18) | (((FIT_LARGE_TYPE)(C1) & (FIT_LARGE_TYPE)0x3F) << 12) | \
	 (((FIT_LARGE_TYPE)(C2) & (FIT_LARGE_TYPE)0x3F) << 6) | (((FIT_LARGE_TYPE)(C3) & (FIT_LARGE_TYPE)0x3F) << 0))
...
#define UTF8_POINT_TO_2UNIT_CONT1(POINT)                                                                               \
	((((FIT_LARGE_TYPE)(POINT) >> 0) & (FIT_LARGE_TYPE)0x3F) | (FIT_LARGE_TYPE)0x80)
#define UTF8_POINT_TO_3UNIT_LEAD(POINT)                                                                                \
	((((FIT_LARGE_TYPE)(POINT) >> 12) & (FIT_LARGE_TYPE)0x0F) | (FIT_LARGE_TYPE)0xE0)
#define UTF8_POINT_TO_3UNIT_CONT1(POINT)                                                                               \
	((((FIT_LARGE_TYPE)(POINT) >> 6) & (FIT_LARGE_TYPE)0x3F) | (FIT_LARGE_TYPE)0x80)
#define UTF8_POINT_TO_3UNIT_CONT2(POINT)                                                                               \
	((((FIT_LARGE_TYPE)(POINT) >> 0) & (FIT_LARGE_TYPE)0x3F) | (FIT_LARGE_TYPE)0x80)
#define UTF8_POINT_TO_4UNIT_LEAD(POINT)                                                                                \
	((((FIT_LARGE_TYPE)(POINT) >> 18) & (FIT_LARGE_TYPE)0x07) | (FIT_LARGE_TYPE)0xF0)
#define UTF8_POINT_TO_4UNIT_CONT1(POINT)                                                                               \
	((((FIT_LARGE_TYPE)(POINT) >> 12) & (FIT_LARGE_TYPE)0x3F) | (FIT_LARGE_TYPE)0x80)
#define UTF8_POINT_TO_4UNIT_CONT2(POINT)                                                                               \
	((((FIT_LARGE_TYPE)(POINT) >> 6) & (FIT_LARGE_TYPE)0x3F) | (FIT_LARGE_TYPE)0x80)
#define UTF8_POINT_TO_4UNIT_CONT3(POINT)                                                                               \
	((((FIT_LARGE_TYPE)(POINT) >> 0) & (FIT_LARGE_TYPE)0x3F) | (FIT_LARGE_TYPE)0x80)
...
#define UTF16_IS_UNIT_1UNIT(UNIT)                                                                                      \
	(((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFFFF) <= (FIT_LARGE_TYPE)0xD7FF) ||                                 \
	  (((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFFFF) >= (FIT_LARGE_TYPE)0xE000))                                   \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF16_IS_UNIT_2UNIT_LEAD(UNIT)                                                                                 \
	(((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFFFF) >= (FIT_LARGE_TYPE)0xD800) &&                                 \
	  (((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFFFF) <= (FIT_LARGE_TYPE)0xDBFF))                                   \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF16_IS_UNIT_2UNIT_TAIL(UNIT)                                                                                 \
	(((((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFFFF) >= (FIT_LARGE_TYPE)0xDC00) &&                                 \
	  (((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFFFF) <= (FIT_LARGE_TYPE)0xDFFF))                                   \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF16_IS_POINT_1UNIT(POINT)                                                                                    \
	(((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x00FFFF)) ? (FIT_TRUE) : (FIT_FALSE))
#define UTF16_IS_POINT_2UNIT(POINT)                                                                                    \
	(((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) >= (FIT_LARGE_TYPE)0x010000) &&                            \
	  (((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) <= (FIT_LARGE_TYPE)0x10FFFF))                              \
	     ? (FIT_TRUE)                                                                                                  \
	     : (FIT_FALSE))
#define UTF16_1UNIT_TO_POINT(UNIT) ((FIT_LARGE_TYPE)(UNIT) & (FIT_LARGE_TYPE)0xFFFF)
#define UTF16_2UNIT_TO_POINT(LEAD, TAIL)                                                                               \
	(((((FIT_LARGE_TYPE)(LEAD) & (FIT_LARGE_TYPE)0xFFFF) - (FIT_LARGE_TYPE)0xD800) << 10) +                            \
	 ((((FIT_LARGE_TYPE)(TAIL) & (FIT_LARGE_TYPE)0xFFFF) - (FIT_LARGE_TYPE)0xDC00) << 0) + (FIT_LARGE_TYPE)0x10000)
#define UTF16_POINT_TO_1UNIT(POINT) ((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0xFFFF)
#define UTF16_POINT_TO_2UNIT_LEAD(POINT)                                                                               \
	((((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) - (FIT_LARGE_TYPE)0x10000) >> 10) &                       \
	  (FIT_LARGE_TYPE)0x3FF) +                                                                                         \
	 (FIT_LARGE_TYPE)0xD800)
#define UTF16_POINT_TO_2UNIT_TAIL(POINT)                                                                               \
	((((((FIT_LARGE_TYPE)(POINT) & (FIT_LARGE_TYPE)0x1FFFFF) - (FIT_LARGE_TYPE)0x10000) >> 0) &                        \
	  (FIT_LARGE_TYPE)0x3FF) +                                                                                         \
	 (FIT_LARGE_TYPE)0xDC00)
...
public:
	StringConversionException(const FIT_STRING_CONVERSION_ERROR newErrorCode = FIT_STRING_CONVERSION_ERROR_INVALID)
	    : RuntimeException(std::string("")), errorCode(newErrorCode) {
	}
...
FIT_BOOL ConvertStringEncoding(STRING_TYPE_DST &strDst, const FIT_UNICODE_ENCODING dstEncoding,
                               const STRING_TYPE_SRC &strSrc, const FIT_UNICODE_ENCODING srcEncoding) {
...
Unicode::UTF8_STRING Unicode::Encode_BaseToUTF8(const FIT_WSTRING &strSrc) {
	...
	if (ConvertStringEncoding<Unicode::UTF8_STRING, Unicode::UTF8_STRING::value_type, FIT_WSTRING,
	                          FIT_WSTRING::value_type>(strDst, FIT_UNICODE_ENCODING_UTF8, strSrc,
	                                                   INTERNAL_UNICODE_ENCODING))
		return strDst;
	else
...
FIT_WSTRING Unicode::Encode_UTF8ToBase(const Unicode::UTF8_STRING &strSrc) {
	FIT_WSTRING strDst;
	if (ConvertStringEncoding<FIT_WSTRING, FIT_WSTRING::value_type, Unicode::UTF8_STRING,
	                          Unicode::UTF8_STRING::value_type>(strDst, INTERNAL_UNICODE_ENCODING, strSrc,
	                                                            FIT_UNICODE_ENCODING_UTF8))
		return strDst;
	else
