...
public:
	...
	void SetDurationTime(FIT_FLOAT32 durationTime) {
		SetFieldFLOAT32Value(2, durationTime, 0,
		                     (FIT_UINT16)Profile::WORKOUT_STEP_MESG_DURATION_VALUE_FIELD_DURATION_TIME);
	}
	...
	FIT_FLOAT32 GetDurationDistance(void) const {
		return GetFieldFLOAT32Value(2, 0,
		                            (FIT_UINT16)Profile::WORKOUT_STEP_MESG_DURATION_VALUE_FIELD_DURATION_DISTANCE);
	}
	...
	void SetDurationDistance(FIT_FLOAT32 durationDistance) {
		SetFieldFLOAT32Value(2, durationDistance, 0,
		                     (FIT_UINT16)Profile::WORKOUT_STEP_MESG_DURATION_VALUE_FIELD_DURATION_DISTANCE);
	}
	...
	void SetDurationCalories(FIT_UINT32 durationCalories) {
		SetFieldUINT32Value(2, durationCalories, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_DURATION_VALUE_FIELD_DURATION_CALORIES);
	}
	...
	// Comment: message_index of step to loop back to. Steps are assumed to be in the order by message_index.
	// custom_name and intensity members are undefined for this duration type.
	///////////////////////////////////////////////////////////////////////
	...
	void SetDurationStep(FIT_UINT32 durationStep) {
		SetFieldUINT32Value(2, durationStep, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_DURATION_VALUE_FIELD_DURATION_STEP);
	}
	...
	void SetDurationPower(FIT_WORKOUT_POWER durationPower) {
		SetFieldUINT32Value(2, durationPower, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_DURATION_VALUE_FIELD_DURATION_POWER);
	}
	...
	void SetDurationReps(FIT_UINT32 durationReps) {
		SetFieldUINT32Value(2, durationReps, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_DURATION_VALUE_FIELD_DURATION_REPS);
	}
	...
	void SetTargetSpeedZone(FIT_UINT32 targetSpeedZone) {
		SetFieldUINT32Value(4, targetSpeedZone, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_TARGET_VALUE_FIELD_TARGET_SPEED_ZONE);
	}
	...
	void SetTargetHrZone(FIT_UINT32 targetHrZone) {
		SetFieldUINT32Value(4, targetHrZone, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_TARGET_VALUE_FIELD_TARGET_HR_ZONE);
	}
	...
	void SetTargetCadenceZone(FIT_UINT32 targetCadenceZone) {
		SetFieldUINT32Value(4, targetCadenceZone, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_TARGET_VALUE_FIELD_TARGET_CADENCE_ZONE);
	}
	...
	void SetTargetPowerZone(FIT_UINT32 targetPowerZone) {
		SetFieldUINT32Value(4, targetPowerZone, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_TARGET_VALUE_FIELD_TARGET_POWER_ZONE);
	}
	...
	void SetRepeatDistance(FIT_FLOAT32 repeatDistance) {
		SetFieldFLOAT32Value(4, repeatDistance, 0,
		                     (FIT_UINT16)Profile::WORKOUT_STEP_MESG_TARGET_VALUE_FIELD_REPEAT_DISTANCE);
	}
	...
	void SetRepeatCalories(FIT_UINT32 repeatCalories) {
		SetFieldUINT32Value(4, repeatCalories, 0,
		                    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_TARGET_VALUE_FIELD_REPEAT_CALORIES);
	}
	...
	void SetTargetStrokeType(FIT_SWIM_STROKE targetStrokeType) {
		SetFieldENUMValue(4, targetStrokeType, 0,
		                  (FIT_UINT16)Profile::WORKOUT_STEP_MESG_TARGET_VALUE_FIELD_TARGET_STROKE_TYPE);
	}
	...
	FIT_BOOL IsCustomTargetSpeedLowValid() const {
		...
		if (!CanSupportSubField(
		        field, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_SPEED_LOW)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_SPEED_LOW);
	}
	...
	FIT_FLOAT32 GetCustomTargetSpeedLow(void) const {
		return GetFieldFLOAT32Value(
		    5, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_SPEED_LOW);
	}
	...
	void SetCustomTargetSpeedLow(FIT_FLOAT32 customTargetSpeedLow) {
		SetFieldFLOAT32Value(
		    5, customTargetSpeedLow, 0,
		    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_SPEED_LOW);
	}
	...
	FIT_BOOL IsCustomTargetHeartRateLowValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_HEART_RATE_LOW)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_HEART_RATE_LOW);
	}
	...
	FIT_WORKOUT_HR GetCustomTargetHeartRateLow(void) const {
		return GetFieldUINT32Value(
		    5, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_HEART_RATE_LOW);
	}
	...
	FIT_BOOL IsCustomTargetCadenceLowValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_CADENCE_LOW)) {
			return FIT_FALSE;
		}
	...
	FIT_UINT32 GetCustomTargetCadenceLow(void) const {
		return GetFieldUINT32Value(
		    5, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_CADENCE_LOW);
	}
	...
	FIT_BOOL IsCustomTargetPowerLowValid() const {
		...
		if (!CanSupportSubField(
		        field, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_POWER_LOW)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_POWER_LOW);
	}
	...
	FIT_WORKOUT_POWER GetCustomTargetPowerLow(void) const {
		return GetFieldUINT32Value(
		    5, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_POWER_LOW);
	}
	...
	void SetCustomTargetPowerLow(FIT_WORKOUT_POWER customTargetPowerLow) {
		SetFieldUINT32Value(
		    5, customTargetPowerLow, 0,
		    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_LOW_FIELD_CUSTOM_TARGET_POWER_LOW);
	}
	...
	FIT_BOOL IsCustomTargetSpeedHighValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_SPEED_HIGH)) {
			return FIT_FALSE;
		}
	...
	FIT_FLOAT32 GetCustomTargetSpeedHigh(void) const {
		return GetFieldFLOAT32Value(
		    6, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_SPEED_HIGH);
	}
	...
	FIT_BOOL IsCustomTargetHeartRateHighValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_HEART_RATE_HIGH)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_HEART_RATE_HIGH);
	}
	...
	FIT_WORKOUT_HR GetCustomTargetHeartRateHigh(void) const {
		return GetFieldUINT32Value(
		    6, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_HEART_RATE_HIGH);
	}
	...
	FIT_BOOL IsCustomTargetCadenceHighValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_CADENCE_HIGH)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_CADENCE_HIGH);
	}
	...
	FIT_UINT32 GetCustomTargetCadenceHigh(void) const {
		return GetFieldUINT32Value(
		    6, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_CADENCE_HIGH);
	}
	...
	FIT_BOOL IsCustomTargetPowerHighValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_POWER_HIGH)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_POWER_HIGH);
	}
	...
	FIT_WORKOUT_POWER GetCustomTargetPowerHigh(void) const {
		return GetFieldUINT32Value(
		    6, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_CUSTOM_TARGET_VALUE_HIGH_FIELD_CUSTOM_TARGET_POWER_HIGH);
	}
	...
	FIT_UINT32 GetSecondaryTargetSpeedZone(void) const {
		return GetFieldUINT32Value(
		    20, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_SPEED_ZONE);
	}
	...
	FIT_BOOL IsSecondaryTargetHrZoneValid() const {
		...
		if (!CanSupportSubField(
		        field, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_HR_ZONE)) {
			return FIT_FALSE;
		}
	...
	FIT_UINT32 GetSecondaryTargetHrZone(void) const {
		return GetFieldUINT32Value(
		    20, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_HR_ZONE);
	}
	...
	FIT_BOOL IsSecondaryTargetCadenceZoneValid() const {
		...
		if (!CanSupportSubField(
		        field,
		        (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_CADENCE_ZONE)) {
			return FIT_FALSE;
		}

		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_CADENCE_ZONE);
	}
	...
	FIT_UINT32 GetSecondaryTargetCadenceZone(void) const {
		return GetFieldUINT32Value(
		    20, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_CADENCE_ZONE);
	}
	...
	void SetSecondaryTargetCadenceZone(FIT_UINT32 secondaryTargetCadenceZone) {
		SetFieldUINT32Value(
		    20, secondaryTargetCadenceZone, 0,
		    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_CADENCE_ZONE);
	}
	...
	FIT_BOOL IsSecondaryTargetPowerZoneValid() const {
		...
		return field->IsValueValid(
		    0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_POWER_ZONE);
	}
	...
	FIT_UINT32 GetSecondaryTargetPowerZone(void) const {
		return GetFieldUINT32Value(
		    20, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_POWER_ZONE);
	}
	...
	FIT_SWIM_STROKE GetSecondaryTargetStrokeType(void) const {
		return GetFieldENUMValue(
		    20, 0, (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_STROKE_TYPE);
	}
	...
	void SetSecondaryTargetStrokeType(FIT_SWIM_STROKE secondaryTargetStrokeType) {
		SetFieldENUMValue(
		    20, secondaryTargetStrokeType, 0,
		    (FIT_UINT16)Profile::WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_STROKE_TYPE);
	}
	...
	FIT_BOOL IsSecondaryCustomTargetSpeedLowValid() const {
		...
		return field->IsValueValid(
		    0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_LOW_FIELD_SECONDARY_CUSTOM_TARGET_SPEED_LOW);
	}
	...
	void SetSecondaryCustomTargetSpeedLow(FIT_FLOAT32 secondaryCustomTargetSpeedLow) {
		SetFieldFLOAT32Value(
		    21, secondaryCustomTargetSpeedLow, 0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_LOW_FIELD_SECONDARY_CUSTOM_TARGET_SPEED_LOW);
	}
	...
	void SetSecondaryCustomTargetHeartRateLow(FIT_WORKOUT_HR secondaryCustomTargetHeartRateLow) {
		SetFieldUINT32Value(
		    21, secondaryCustomTargetHeartRateLow, 0,
		    (FIT_UINT16)Profile::
		        WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_LOW_FIELD_SECONDARY_CUSTOM_TARGET_HEART_RATE_LOW);
	}
	...
	FIT_BOOL IsSecondaryCustomTargetCadenceLowValid() const {
		...
		return field->IsValueValid(
		    0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_LOW_FIELD_SECONDARY_CUSTOM_TARGET_CADENCE_LOW);
	}
	...
	void SetSecondaryCustomTargetCadenceLow(FIT_UINT32 secondaryCustomTargetCadenceLow) {
		SetFieldUINT32Value(
		    21, secondaryCustomTargetCadenceLow, 0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_LOW_FIELD_SECONDARY_CUSTOM_TARGET_CADENCE_LOW);
	}
	...
	FIT_BOOL IsSecondaryCustomTargetPowerLowValid() const {
		...
		return field->IsValueValid(
		    0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_LOW_FIELD_SECONDARY_CUSTOM_TARGET_POWER_LOW);
	}
	...
	void SetSecondaryCustomTargetPowerLow(FIT_WORKOUT_POWER secondaryCustomTargetPowerLow) {
		SetFieldUINT32Value(
		    21, secondaryCustomTargetPowerLow, 0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_LOW_FIELD_SECONDARY_CUSTOM_TARGET_POWER_LOW);
	}
	...
	FIT_BOOL IsSecondaryCustomTargetSpeedHighValid() const {
		...
		return field->IsValueValid(
		    0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_HIGH_FIELD_SECONDARY_CUSTOM_TARGET_SPEED_HIGH);
	}
	...
	void SetSecondaryCustomTargetSpeedHigh(FIT_FLOAT32 secondaryCustomTargetSpeedHigh) {
		SetFieldFLOAT32Value(
		    22, secondaryCustomTargetSpeedHigh, 0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_HIGH_FIELD_SECONDARY_CUSTOM_TARGET_SPEED_HIGH);
	}
	...
	void SetSecondaryCustomTargetHeartRateHigh(FIT_WORKOUT_HR secondaryCustomTargetHeartRateHigh) {
		SetFieldUINT32Value(
		    22, secondaryCustomTargetHeartRateHigh, 0,
		    (FIT_UINT16)Profile::
		        WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_HIGH_FIELD_SECONDARY_CUSTOM_TARGET_HEART_RATE_HIGH);
	}
	...
	void SetSecondaryCustomTargetCadenceHigh(FIT_UINT32 secondaryCustomTargetCadenceHigh) {
		SetFieldUINT32Value(
		    22, secondaryCustomTargetCadenceHigh, 0,
		    (FIT_UINT16)Profile::
		        WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_HIGH_FIELD_SECONDARY_CUSTOM_TARGET_CADENCE_HIGH);
	}
	...
	FIT_BOOL IsSecondaryCustomTargetPowerHighValid() const {
		...
		return field->IsValueValid(
		    0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_HIGH_FIELD_SECONDARY_CUSTOM_TARGET_POWER_HIGH);
	}
	...
	void SetSecondaryCustomTargetPowerHigh(FIT_WORKOUT_POWER secondaryCustomTargetPowerHigh) {
		SetFieldUINT32Value(
		    22, secondaryCustomTargetPowerHigh, 0,
		    (FIT_UINT16)
		        Profile::WORKOUT_STEP_MESG_SECONDARY_CUSTOM_TARGET_VALUE_HIGH_FIELD_SECONDARY_CUSTOM_TARGET_POWER_HIGH);
	}
};
