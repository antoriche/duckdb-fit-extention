...
void ThreeDSensorAdjustmentPlugin::ProcessCalibrationFactor(fit::Mesg &mesg, const FIT_UINT8 *fieldsXYZ,
                                                            const FIT_FLOAT32 calibratedXYZ[]) {
...
void ThreeDSensorAdjustmentPlugin::adjustSensorData(FIT_FLOAT32 (&rawData)[3], CalibrationParameters calParams) {
	...
	// [Rotation] * [XYZ]
	rawData[0] = calParams.rotationMatrix[0][0] * tempData[0] + calParams.rotationMatrix[0][1] * tempData[1] +
	             calParams.rotationMatrix[0][2] * tempData[2];
	rawData[1] = calParams.rotationMatrix[1][0] * tempData[0] + calParams.rotationMatrix[1][1] * tempData[1] +
	             calParams.rotationMatrix[1][2] * tempData[2];
	rawData[2] = calParams.rotationMatrix[2][0] * tempData[0] + calParams.rotationMatrix[2][1] * tempData[1] +
	             calParams.rotationMatrix[2][2] * tempData[2];
}
} // namespace fit
